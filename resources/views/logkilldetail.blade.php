...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- Topbar -->
        @include('navbar', ['title' => '<h1 class="font-weight-semibold text-gray-900 h2 mb-0"><a href="/logkill" class="btn bg-transparent"><i class="fa fa-chevron-left text-gray-900"></i></a><span class="h4 font-weight-semibold text-gray-900 ">Log Kill Switch - steambox 1</span></h1>', 'subtitle' => ''])
                        ...
                        <div class="col">
                            <div class="d-flex search-bar px-3 py-2 mb-3 rounded-3 justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-center button-header">
                                    <button class="btn bg-white text-gray-600 shadow py-1"  id="downloadExcel" type="button"><span class="material-symbols-outlined">sim_card_download</span> Export Excel</button>
