...
<body id="logmaintenance-page">
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            <div class="row no-gutters align-items-center">
                                <div class="col">
                                    <div
                                        class="d-flex search-bar px-3 py-2 mb-3 rounded-3 justify-content-between align-items-center">
                                        <div class="d-flex">
                                            <form class="search-form mr-3">
                                                <div class="input-group">
                                                    <input type="text" class="form-control bg-light border-0 small"
                                                        placeholder="Search Resep" aria-label="Search"
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <form action="" class="d-flex align-items-center mr-4">
                                                ...
                                                <button class="btn bg-white text-gray-700 py-1 shadow"
                                                    fdprocessedid="ivd7uo"><i class="fa fa-save"></i></button>
                                            </form>
                                            <div class="d-flex align-items-center button-header">
                                                <button class="btn bg-white text-gray-600 shadow py-1"
                                                    id="downloadExcel" type="button" disabled><span
                                                        class="material-symbols-outlined">sim_card_download</span>
                                                    Export CSV</button>
                                                <button class="btn bg-white text-gray-600 shadow ml-3 py-1"
                                                    id="downloadPdf" type="button" disabled><span
                                                        class="material-symbols-outlined">sim_card_download</span>
                                                    Export pdf</button>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="table-wrap">
                                                        <table id="logmaintenanceTable" class="defaultTable table"
                                                            style="">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-wrap">
                                                                        <button type="button"
                                                                            ...
                                                                            data-toggle="modal"
                                                                            data-target="#ubahKeterangan"
                                                                            fdprocessedid="a75jlj">
                                                                            Ubah Keterangan
                                                                            <span class="material-symbols-outlined">
                                                                                edit_note
                                                                            </span>
                                                                        </button>
                                                                        <a href="/logkilldetail"
                                                    ...
                                                    <div
                                                        class="row align-items-center mt-3 pagination-table px-4 font-weight-semibold">
    ...
    <div class="modal fade" id="ubahKeterangan" tabindex="-1" role="dialog" aria-labelledby="ubahKeteranganLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="">
                        ...
                        <div class="mb-3">
                            <label for="keteranganmaintenance">Keterangan Kill Switch</label>
